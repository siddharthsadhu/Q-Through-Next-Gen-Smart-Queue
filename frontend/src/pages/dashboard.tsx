...
const Dashboard = () => {
    ...
    const [queue_entries, setQueue_entries] = React.useState(loadingMessage);
    const [services, setServices] = React.useState(loadingMessage);

    async function loadData() {
        const entities = ['users','customers','queue_entries','services',];
        const fns = [setUsers,setCustomers,setQueue_entries,setServices,];
    ...
    <>
      ...
      <SectionMain>
        ...
        <div id="dashboard" className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
            ...
            <Link href={'/queue_entries/queue_entries-list'}>
                <div
                    className={`${corners !== 'rounded-full'? corners : 'rounded-3xl'} dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                >
                    <div className="flex justify-between align-center">
                    ...
                    <div className="flex justify-between align-center">
                        ...
                        <div>
                            <BaseIcon
                                ...
                                // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                // @ts-ignore
                                path={'mdiScissorsCutting' in icon ? icon['mdiScissorsCutting' as keyof typeof icon] : icon.mdiTable || icon.mdiTable}
                            />
                        </div>
                    </div>
                </div>
